export const questions = [
  ...
  { id: 'mh7', text: "Social media is deliberately designed to be addictive in ways that aren't good for me", category: 'mentalHealth', direction: 'D' },
  { id: 'mh8', text: "I would generally be happier if I used social media less", category: 'mentalHealth', direction: 'D' },

  // Social Status
  { id: 'ss1', text: "Social media is a genuine tool for getting ahead in life", category: 'socialStatus', direction: 'P' },
  { id: 'ss2', text: "Not being on social media would put me at a real disadvantage socially or professionally", category: 'socialStatus', direction: 'P' },
  ...
  { id: 'ss5', text: "I feel like I have to be on social media whether I want to be or not", category: 'socialStatus', direction: 'R' },
  { id: 'ss6', text: "I shouldn't have to be on social media to be taken seriously professionally or socially", category: 'socialStatus', direction: 'R' },
  { id: 'ss7', text: "Social media platforms have too much power over whether I can participate in society", category: 'socialStatus', direction: 'R' },
  ...
  { id: 'id2', text: "I am more authentic online than I'm given credit for", category: 'identity', direction: 'G' },
